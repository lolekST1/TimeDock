...
import 'package:timedock/features/reports/reports_screen.dart';

void main() {
  testWidgets('report groups a task\'s sessions and shows the total',
      (tester) async {
    ...
    await container.read(sessionRepositoryProvider).upsertAll([
      ...
      s('b', base.add(const Duration(hours: 3)), const Duration(hours: 1, minutes: 15)),
    ]);

    // Focus the report on this day.
    ...
    await tester.pumpWidget(UncontrolledProviderScope(
      container: container,
      child: const MaterialApp(home: ReportsScreen(workspaceId: 'w1')),
    ));
